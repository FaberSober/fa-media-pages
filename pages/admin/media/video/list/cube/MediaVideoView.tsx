...
export default function MediaVideoView({item}: MediaVideoViewProps) {
  return (
    <Descriptions column={1} bordered>
      ...
      <Descriptions.Item label="原视频文件ID -> base_file_save.id">{item.originFileId}</Descriptions.Item>
      ...
      <Descriptions.Item label="720p转码视频文件ID -> base_file_save.id">{item.trans720pFileId}</Descriptions.Item>
      <Descriptions.Item label="720p视频大小（MB）">{item.trans720pSizeMb}</Descriptions.Item>
      <Descriptions.Item label="封面图文件ID -> base_file_save.id">{item.coverFileId}</Descriptions.Item>
      <Descriptions.Item label="预览视频文件ID -> base_file_save.id">{item.previewFileId}</Descriptions.Item>
